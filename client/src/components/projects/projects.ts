...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A home automation tool that programs Philips Hue smart lights for synchronized effects across multiple bulbs, like a bouncing colour pulse or a heartbeat rhythm. Built with Python, talking directly to the Hue Bridge over the local network.",
    url: "https://github.com/AlexSteeves/PhilipsHueLightAutomation",
    tags: ["Python", "Automation", "Philips Hue"],
    highlights: [
      "bounce.py: sequential white light pulses move across the lights with fade transitions.",
      "bounce_color.py: the same bounce pattern, alternating between purple and gold.",
      "heartbeat.py: a double-pulse effect mimicking a heartbeat across all lights.",
      "All scripts restore original light states on Ctrl+C.",
    ],
  },
];
